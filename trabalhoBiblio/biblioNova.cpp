        ...
        switch(escolha_menu)
        {
            ...
            case '6':
               /* cout << " -----------------------------------------------------\n";
                ...
                cout << "|                1- LIVRO                             |\n";
                cout << "|                2- REVISTA                           |\n";
                cout << "|                3- AUTOR, EDITORA, USUARIO           |\n";
                cout << "|                4- SAIR                              |\n";
                cout << "|                                                     |\n";
                cout << "|                                                     |\n";
                cout << " -----------------------------------------------------\n";
                char alterar = getchar();
                int alteracao;
                switch (alterar)
                {
                    case '1':
                        mostrarTodoVetor(Livros, tam_L, 'L');
                        system("pause");
                        cout << "Digite o id do Livro que você queira alterar: " << endl;
                       //alterar
                    break;
                    ...
                    case '2':
                        ...
                        system("pause");
                        cout << "Digite o id do Revista que você queira alterar: " << endl;
                       //alterar
                    break;
        ...
        switch(escolha_menu)
        {
            ...
            case '2':
                ...
                do
                {
                    ...
                    cout << "|                                                     |\n";
                    cout << "|                                                     |\n";
                    cout << "|          1- PESQUISAR POR TITULO, ASSUNTO, NOMES    |\n";
                    cout << "|          2- CADASTRAR POR ID(IDENTIFICACAO)         |\n";
                    cout << "|          3- SAIR                                    |\n";
                    cout << "|                                                     |\n";
                    cout << "|                                                     |\n";
                    cout << " -----------------------------------------------------\n";
